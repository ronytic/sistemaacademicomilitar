...
<form name="Sample" method="post" action="detalle.php">
  <table width="77%" height="383" align="center">
    <tr> 
    ...
    <tr> 
      <td height="15" colspan="3"> <div align="center"><strong><font size="3" face="Arial, Helvetica, sans-serif"><u>HISTORIAL 
          ACADEMICO</u></font></strong></div></td>
    </tr>
    <tr> 
          ...
          <table width="82%">
            ...
            <tr> 
              <td><div align="center"><strong><font size="2" face="Arial, Helvetica, sans-serif"> 
                  <?php
					$consulta = mysql_query("SELECT * FROM nprimero WHERE ci = '$buscar'"); 
					if($row = mysql_fetch_array($consulta)) 
					{
					echo "<table width='95%' border='0' cellpadding='1' cellspacing='1' id='tblDatos' style='width:100%;'>";
					...
					$consulta = mysql_query("SELECT * FROM nsegundo WHERE ci = '$buscar'"); 
					if($row = mysql_fetch_array($consulta)) 
					{
					echo "<table width='95%' border='0' cellpadding='1' cellspacing='1' id='tblDatos' style='width:100%;'>";
  					echo "<tr align='Center' bgcolor='#000033'>"; 
					...
					$consulta = mysql_query("SELECT * FROM ntercero WHERE ci = '$buscar'"); 
					if($row = mysql_fetch_array($consulta)) 
					{
					echo "<table width='95%' border='0' cellpadding='1' cellspacing='1' id='tblDatos' style='width:100%;'>";
  					echo "<tr align='Center' bgcolor='#000033'>"; 
    ...
    <tr>
      <td height="75" colspan="3"><table width="82%" align="center">
          <tr> 
            <td><div align="center"><strong><font size="2" face="Arial, Helvetica, sans-serif"><u>Curso 
          ...
          <tr> 
            <td><div align="center"><strong><font size="2" face="Arial, Helvetica, sans-serif"> 
                <?php
					$consulta = mysql_query("SELECT * FROM nbasico WHERE ci = '$buscar'"); 
					if($row = mysql_fetch_array($consulta)) 
					{
					echo "<table width='95%' border='0' cellpadding='1' cellspacing='1' id='tblDatos' style='width:100%;'>";
  					echo "<tr align='Center' bgcolor='#000033'>"; 
					...
					$consulta = mysql_query("SELECT * FROM navanzado WHERE ci = '$buscar'"); 
					if($row = mysql_fetch_array($consulta)) 
					{
					echo "<table width='95%' border='0' cellpadding='1' cellspacing='1' id='tblDatos' style='width:100%;'>";
  					echo "<tr align='Center' bgcolor='#000033'>"; 
