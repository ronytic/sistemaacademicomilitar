...
<form name="Sample" method="post" action="buscarx.php"> 
...
<div align="center">
          <p><font size="2" face="Arial, Helvetica, sans-serif"> 
            <?php
					...
					$consulta = mysql_query("SELECT * FROM docente WHERE (paterno LIKE '$buscar%' OR paterno = '$buscar') AND '$buscar' <> '' ORDER BY paterno ASC"); 
