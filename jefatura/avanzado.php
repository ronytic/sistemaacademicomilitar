...
<table width="100%" border="0" cellspacing="0" cellpadding="0" align="left">
  <tr valign="top">
    <td width="41%" align="center"> 
      <form name="fcalen" method="Post" action="avanzado.php">
        <table width="52%">
          <tr>
			  ...
			  ?>
                      ...
                      <tr> 
                        ...
                        <td><select name="grado" id="grado">
                            <option selected>SOF. INCL.</option>
                          </select>
	...
	// REVISED CODE
	$result = mysql_query("SELECT * FROM alumno WHERE gestion = $ano AND curso = 'avanzado' ORDER BY ci ASC");
	...
	if ($c%2 == 0) 
		...
		print "		<a href=\"avanzado.php?act=Edit&ci=".$row['ci']."\">";
		print 		$row['ci'];
		print "		</a>";
		print "	   </font></div>";
        print "  </td>";
