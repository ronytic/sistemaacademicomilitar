...
<?
	...
	$listteams = mysql_query("SELECT * FROM docente");
...
// ADD USER
if ($action == "Add") {
	$situation = $user->add_user($ci, $grado, $espe, $nombres, $paterno, $materno, $fec_nac, $lugar, $direccion, $fono, $celular, $gsanguineo, $gestion);
...
if ($action=="Delete") {
	...
	$deletesignup =  mysql_query("DELETE FROM docente WHERE ci='$ci'");
...
// MODIFY USER
if ($action == "Modify") {
	$update = $user->modify_user($ci, $grado, $espe, $nombres, $paterno, $materno, $fec_nac, $lugar, $direccion, $fono, $celular, $gsanguineo, $gestion);

	if ($update==1) {
		$message = "Datos actualizados del Docente";
	}
	elseif ($update == "blank ci") {
		$message = "introduzca el C.I. del Docente";
		$action = "";
	}
	else {
		$message = "";
...
{
    $ci = $_GET['ci'];
	$listusers = mysql_query("SELECT * 	FROM docente WHERE ci='$ci'");
	...
	$gestion = $ano;
	$message = "Modificar datos del Docente";
}
...
if ($action == "Add New") {
	...
	$gestion = $ano;
	$act = "";
	$message = "Introducir datos del Docente";
}
...
if ($action == "Limpiar") {
	...
	$gestion = $ano;
	$act = "";
	$message = "Formulario sin Datos del Docente";
}
?>
<html>
<head>
...
<table width="100%" border="0" cellspacing="0" cellpadding="0" align="left">
  <tr valign="top">
    <td width="41%" align="center"> 
      <form name="fcalen" method="Post" action="docente.php">
        <table width="52%">
          <tr>
            ...
            <td width="81%"><table width="345" height="273" border="1" align="center" cellpadding="0" cellspacing="0" bordercolor="#000000" bgcolor="#CCCCCC">
			  ...
			  ?>
                      ...
                      <tr> 
                        ...
                        <td> <font face="Verdana, Arial, Helvetica, sans-serif" size="2"><? print "<input type=\"text\" name=\"grado\" size=\"15\" maxlength=\"15\" value=\"$grado\">"; ?></font><font color="#000000">&nbsp; 
                          </font></td>
                      </tr>
                      <tr> 
                        ...
                        <td><font face="Verdana, Arial, Helvetica, sans-serif" size="2"><? print "<input type=\"text\" name=\"espe\" size=\"15\" maxlength=\"15\" value=\"$espe\">"; ?></font></td>
                      </tr>
                      <tr> 
                        <td height="21" bgcolor="#FFFFFF"> <div align="right"><font color="#000000"><strong><font size="2" face="Arial, Helvetica, sans-serif">* 
	...
	// REVISED CODE
	$result = mysql_query("SELECT * FROM docente WHERE gestion = $ano ORDER BY ci ASC");
	...
	if ($c%2 == 0) 
		...
		print "		<a href=\"docente.php?act=Edit&ci=".$row['ci']."\">";
		print 		$row['ci'];
		print "		</a>";
		print "	   </font></div>";
        print "  </td>";
