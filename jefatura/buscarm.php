...
<form name="Sample" method="post" action="buscarm.php"> 
          ...
          <table width="93%">
            ...
            <tr> 
              <td width="45%" height="35" valign="middle"> <div align="right"> 
                  <table width="84%">
                    <tr> 
                      <td bgcolor="#FFFFFF"> <div align="right"><b><font color="#000000" size="2,5" face="Verdana, Arial, Helvetica, sans-serif">MATERIA 
                          :</font></b></div></td>
                    </tr>
                  </table>
                  <b></b></div></td>
...
<div align="center">
          <p><font size="2" face="Arial, Helvetica, sans-serif"> 
            <?php
					...
					$consulta = mysql_query("SELECT * FROM materia WHERE (materia LIKE '$buscar%' OR materia = '$buscar') AND '$buscar' <> '' ORDER BY materia ASC"); 
					if($row = mysql_fetch_array($consulta)) 
{
	...
	echo "<th width='15%' align='Center'><strong><font color='#FFFFFF' size='2' face='Arial, Helvetica, sans-serif'>Codigo</font></strong></td>";
	echo "<th width='20%' align='Center'><strong><font color='#FFFFFF' size='2' face='Arial, Helvetica, sans-serif'>Materia</font></strong></th>";
	echo "<th width='20%' align='Center'><strong><font color='#FFFFFF' size='2' face='Arial, Helvetica, sans-serif'>H. Teoria</font></strong></th>";     
	echo "<th width='20%' align='Center'><strong><font color='#FFFFFF' size='2' face='Arial, Helvetica, sans-serif'>H. Practica</font></strong></th>";	                          
	echo "<th width='20%' align='Center'><strong><font color='#FFFFFF' size='2' face='Arial, Helvetica, sans-serif'>Curso</font></strong></th>";
	echo "</tr>"; 
	echo "</tr>"; 
	do { 
			echo "<tr>";
			echo "<td align='Center'>" .$row["id_materia"]. " </td>";  
			echo "<td align='Center'> " .$row["materia"]. " </td>";
			echo "<td align='Center'> " .$row["hteoria"]. " </td>";
			echo "<td align='Center'> " .$row["practica"]. " </td>";
