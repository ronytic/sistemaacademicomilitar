...
<table width="100%" border="0" cellspacing="0" cellpadding="0" align="left">
  <tr valign="top">
    <td width="41%" align="center"> 
      <form name="fcalen" method="Post" action="registrar.php">
        <table width="52%">
          <tr>
            ...
            <td width="81%"><table width="345" height="273" border="1" align="center" cellpadding="0" cellspacing="0" bordercolor="#000000" bgcolor="#CCCCCC">
			  ...
			  ?>
                      ...
                      <td height="21" bgcolor="#FFFFFF"> <div align="right"><font color="#000000"><strong><font size="2" face="Arial, Helvetica, sans-serif">*Materia:</font></strong></font></div></td>
                      ...
                      <tr> 
                        ...
                        <td><select name="espe" id="espe">
                            <option>1ER. A.M.</option>
                            <option>2DO. A.M.</option>
                            <option>3ER. A.M.</option>
                            <option selected>ELEGIR</option>
                          </select></td>
                      </tr>
                      <tr> 
                        <td height="21" bgcolor="#FFFFFF"> <div align="right"><font color="#000000"><strong><font size="2" face="Arial, Helvetica, sans-serif">*Nota Teoria:</font></strong></font></div></td>
                        <td><font face="Verdana, Arial, Helvetica, sans-serif" size="2"><? print "<input type=\"text\" name=\"teo\" size=\"25\" maxlength=\"25\" value=\"$nombres\">"; ?></font><font color="#000000">&nbsp; 
                          </font></td>
                      </tr>
                      <tr> 
                        <td height="21" bgcolor="#FFFFFF"> <div align="right"><font color="#000000"><strong><font size="2" face="Arial, Helvetica, sans-serif">* 
                        Nota Practica:</font></strong></font></div></td>
                        <td><font face="Verdana, Arial, Helvetica, sans-serif" size="2"><? print "<input type=\"text\" name=\"prac\" size=\"25\" maxlength=\"25\" value=\"$paterno\">"; ?></font><font color="#000000">&nbsp; 
                          </font></td>
                      </tr>
                      <tr>
                        <td height="21" bgcolor="#FFFFFF"><div align="right"><font color="#000000"><strong><font size="2" face="Arial, Helvetica, sans-serif">* 
                          Parcial :</font></strong></font></div></td>
	...
	// REVISED CODE
	$result = mysql_query("SELECT * FROM alumno WHERE gestion = $ano AND curso = 'alumno' ORDER BY ci ASC");
	...
	if ($c%2 == 0) 
		...
		print "		<a href=\"registrar.php?act=Edit&ci=".$row['ci']."\">";
		print 		$row['ci'];
		print "		</a>";
		print "	   </font></div>";
        print "  </td>";
